...
ok('agent.js applyActions clamps body to ±30, not ±20',
  /Math\.max\(-30, Math\.min\(30, actions\.body\.x/.test(agentSrc), 'body.x');
ok('agent.js body.y uses the same ±30 bound',
  /Math\.max\(-30, Math\.min\(30, actions\.body\.y/.test(agentSrc));
ok('agent.js body.z uses the same ±30 bound',
